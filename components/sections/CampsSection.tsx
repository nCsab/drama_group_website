...
import { fetchCampVideos, QUERY_KEYS } from "@/lib/api";
...
export default function CampsSection({ id }: CampsSectionProps) {
    ...
    const { data: campVideos = [] } = useQuery({
        queryKey: QUERY_KEYS.campVideos,
        queryFn: fetchCampVideos,
    });
